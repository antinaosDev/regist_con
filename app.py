...
def generate_document(context, safe_rut, safe_id):
    """Genera el documento DOCX desde la plantilla y devuelve los bytes."""
    ...
    try:
        ...
        # Guardar en un buffer de memoria para evitar problemas de permisos en disco
        target_stream = io.BytesIO()
        doc.save(target_stream)
        docx_bytes = target_stream.getvalue()
        return docx_bytes, None
    except Exception as e:
        return None, f"Error en generación del documento: {e}"
...
with st.expander("📂 Registros Guardados — Generar PDF desde un registro existente", expanded=False):
    ...
    if "sheet_data" in st.session_state and st.session_state["sheet_data"]:
        ...
        if rows:
            ...
            if st.button("📄 Generar Documento del registro seleccionado"):
                ...
                if err:
                    ...
                    st.download_button(
                        ...
                        data=docx_bytes,
                        file_name=f"Protocolo_{safe_rut}_{safe_id}.docx",
